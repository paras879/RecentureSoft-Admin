...
const tabsInjectionPoint = `                                {editPage.path === "/news" && (`;
...
if (content.includes(tabsInjectionPoint)) {
    content = content.replace(tabsInjectionPoint, servicesTabsButtons + tabsInjectionPoint);
    console.log("Successfully injected services tab buttons");
} else {
...
const contentInjectionPoint = `{/* NEWS HERO TAB */}`;
...
if (content.includes(contentInjectionPoint)) {
    content = content.replace(contentInjectionPoint, servicesTabsJSX + contentInjectionPoint);
    fs.writeFileSync(pagePath, content, 'utf8');
    console.log("Successfully injected services tabs into page.jsx!");
} else {
